...
<body>
    ...
    <footer class="footer">
        <p class="align-center footer-msg">Join our social media!</p>
        <div class="footer-icon-container">
            <a href=""><svg class="footer__icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
            ...
            <a href=""><svg class="footer__icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50">
