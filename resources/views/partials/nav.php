<nav class="navbar-container">
    <ul class="navbar-container__list">
        <li class="mobile-menu-container">
            ...
            <a href="<?php echo BASE_URL ?>" class="logo">Shoplaza</a>
        </li>
        <li class="navbar-container__list--hidden">
            <a class="navbar-container__list--anchor-reset logo" href="<?php echo BASE_URL; ?>">Shoplaza</a>
        </li>
        <li class="navbar-container__list--hidden">
    ...
    <ul class="list-reset navbar-container__icon-list">
        ...
        <li>
            <a class="navbar-container__list--anchor-reset link-reset" href="<?php echo BASE_URL . "/cart" ?>">
                <!-- Basket icon -->
                ...
                (<?php echo \App\Services\CartService::getCount(); ?>)
            </a>
        </li>
    </ul>
